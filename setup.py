...
setup(
  name = 'topsis-Akshat-101983042',         # How you named your package folder (MyLib)
  packages = ['topsis-Akshat-101983042'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/akshatkaush/topsis-Akshat-101983042/archive/V_0.1.tar.gz',    # I explain this later on
